export const NewsItem = ({ title, description, src, url }) => {
    ...
    const handleImageError = (event) => {
        event.target.src = './banner.png'; // Replace with your customized image URL
    };
        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7] max-w-80 m-3">
            ...
            <div class="p-4 md:p-5">
                ...
                <p class="mt-1 text-gray-500 dark:text-gray-400">
                    {truncatedDescription ? truncatedDescription : "No description provided. Click below to read more"}
                </p>
                <a
